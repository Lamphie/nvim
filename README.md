...
This neovim configuration using lazy as plugin manager. I will release a pre0.12 version to allow anyone who still want lazy to have an usable release.
...
Any new plugin file added in the `~/.config/nvim/lua/plugins` will be loaded automatically thanks to this [plugin call](https://github.com/Lamphie/nvim/blob/b251fa71a186e631dc9fa2bfd7c75191678ef5f1/lua/config/lazy.lua#L23).
